...
--
-- Table structure for table `chhris_employees`
--

CREATE TABLE `chhris_employees` (
...
--
-- Dumping data for table `chhris_employees`
--

INSERT INTO `chhris_employees` (`EMP_ID`, `FNAME`, `MNAME`, `LNAME`, `ADDRESS`, `SEX`, `DOB`, `PLACE_OF_BIRTH`, `CONTACT_NUM`, `CIVIL_STATUS`, `POSITION`, `DEPT_ID`, `DIV_ID`, `WORK_STATUS`, `HIRED_DATE`, `MANAGER_ID`, `SALARY`, `COMMISSION`) VALUES
...
(15, 'Mc', 'Duck', 'Donald', 'Manila', 'MALE', '2021-06-17', 'Manila', '09082282637', 'SINGLE', 'hr', 1, 2, 'REGULAR', '2021-06-17', 2, 1312321321, 2147483647),
(16, 'Juan', 'Dela', 'Cruz', 'Manila', 'MALE', '2021-06-17', 'Manila', '09082282637', 'SINGLE', 'Manager', 2, 2, 'REGULAR', '2021-06-17', 2, 1312321321, 2147483647),
(17, 'Juan', 'Dela', 'Cruz', 'Manila', 'MALE', '2021-06-17', 'Manila', '09082282637', 'SINGLE', 'Manager', 2, 2, 'REGULAR', '2021-06-17', 2, 1312321321, 2147483647),
(18, 'Mr', 'Regular', 'Employee', 'Manila', 'MALE', '2021-06-17', 'Manila', '09082282637', 'MARRIED', 'Staff', 2, 2, 'INTERN', '2021-06-17', 17, 1312321321, 2147483647);
...
--
-- Indexes for table `chhris_employees`
--
ALTER TABLE `chhris_employees`
...
--
-- AUTO_INCREMENT for table `chhris_employees`
--
ALTER TABLE `chhris_employees`
...
--
-- Constraints for table `chhris_employees`
--
ALTER TABLE `chhris_employees`
  ADD CONSTRAINT `chhris_employees_ibfk_1` FOREIGN KEY (`MANAGER_ID`) REFERENCES `chhris_managers` (`MANAGER_ID`),
  ADD CONSTRAINT `chhris_employees_ibfk_2` FOREIGN KEY (`DEPT_ID`) REFERENCES `chhris_department` (`DEPT_ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `chhris_employees_ibfk_3` FOREIGN KEY (`DIV_ID`) REFERENCES `chhris_division` (`DIV_ID`);
COMMIT;
